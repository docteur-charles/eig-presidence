<footer class="content-footer d-print-none">
    <div>© 2020 GecPRN - <a href="http://laborasyon.com" target="_blank">Laborasyon</a></div>
    <div>
        <nav class="nav">
            <a href="https://themeforest.net/licenses/standard" class="nav-link">Licenses</a>
            <a href="dashboard.html#" class="nav-link">Change Log</a>
            <a href="dashboard.html#" class="nav-link">Get Help</a>
        </nav>
    </div>
</footer>
...
<div class="sidebar-group d-print-none">
        ...
        <div class="sidebar-content">
            ...
            <div>
                <div class="list-group list-group-flush mb-3">
                    <a href="dashboard.html#" class="list-group-item px-0 d-flex align-items-center">
                        <div class="mr-3">
                            <figure class="avatar">
    ...
    <div class="sidebar" id="view-detail">
        <div class="sidebar-header">
            <h4>View Detail</h4>
            <a href="dashboard.html#" class="btn btn-light btn-floating sidebar-close-btn">
        ...
        <div class="sidebar-content">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-7"><a href="dashboard.html#" class="link-1">Meeting-notes.doc</a></div>
            </div>
            <div class="row mb-3">
