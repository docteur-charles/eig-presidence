    ...
    <div class="header-container">
        <div class="header-body">
            ...
            <div class="header-body-right">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a href="dashboard.html#" class="nav-link mobile-header-search-btn" title="Search">
                            <i class="ti-search"></i>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="dashboard.html#" class="nav-link" title="Dark">
                            <i class="fa fa-moon-o"></i>
                        </a>
                    </li>

                    <li class="nav-item dropdown">
                        <a href="dashboard.html#" class="nav-link nav-link-notify" title="Notifications" data-toggle="dropdown">
                            <i class="ti-bell"></i>
                        </a>
                            ...
                            <div class="px-3 py-2 text-right border-top">
                                <ul class="list-inline small">
                                    <li class="list-inline-item mb-0">
                                        <a href="dashboard.html#">Mark All Read</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <li class="nav-item dropdown">
                        <a href="dashboard.html#" class="nav-link" title="Settings" data-sidebar-target="#settings">
                            <i class="ti-settings"></i>
                        </a>
                    </li>

                    <li class="nav-item dropdown">
                        <a href="dashboard.html#" class="nav-link profile-nav-link dropdown-toggle" title="User menu"
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-big">
                            ...
                            <div class="list-group list-group-flush">
                                <a href="dashboard.html#" class="list-group-item" data-sidebar-target="#settings">Settings</a>
