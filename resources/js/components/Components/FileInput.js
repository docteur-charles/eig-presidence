...
export default function FileInput({ _id = 0, onLoaded, onExtensionNotMatch: handleExtensionNotMatch }) {
                   ...
                   return (
                       <div className="row flex-column align-items-center">
                           <div
                               className={`input_${_id} d-flex flex-column col-12 p-2 p-xl-3 align-items-center justify-content-center shadow-sm rounded-pill`}
                               style={{
                                   cursor: "pointer",
                           ...
                           {!file && (
                               <>
                                   <small className="form-text d-inline d-md-none text-center pr-2 pl-2 text-muted">
                                       Cliquez dans la zone de texte pour
                                       commencer.
                                   </small>
                                   <small className="form-text d-none d-md-inline text-center pr-2 pl-2 text-muted">
                                       Cliquez dans la zone de texte et chargez
                                       le courrier à enregistrer depuis un
                                       espace de stockage.
                                   </small>
                               </>
                           )}
