...
export default function Resultat({ isLoading = false }) {
    return (
        <div className="row" style={{ minHeight: "150px" }}>
            <div className="alert alert-danger mx-auto mt-5 mb-1">
                <h2>
                    Cette page est en cours de contruction. Les données
                    affichées ici sont pour les besoins de la démo.
                </h2>
            </div>
            {isLoading ? (
                ...
                <>
                    ...
                    <div className="d-flex col-12 flex-column">
                        <div className="page-header d-flex justify-content-between">
                            <h1 className="border-bottom border-warning">
                                    ...
                                    >
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="badge bg-info-bright text-warning">
                                                        Urgent
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="badge bg-info-bright text-danger">
                                                        Très Urgent
                                                    </div>
                                                </td>
                                                <td>
