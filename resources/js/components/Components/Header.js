...
export default function ({full = false, auth:{nom, prenom, photo, role:{description}}}) {
                                          ...
                                          <li>
                                              ...
                                              >
                                                  ...
                                                  <div className="flex-grow-1">
                                                      <p className="mb-0">
                                                          Your storage space is
                                                          running low!
                                                          <i
                                                              title="Mark as unread"
                                                              data-toggle="tooltip"
                                                              className="hide-show-toggler-item fa fa-check font-size-11 position-absolute right-0 top-0 mr-3 mt-3"
                                                          />
                                                      </p>
                                                  ...
                                                  <div>
                                                      <p className="mb-0">
                                                          ...
                                                          <i
                                                              title="Mark as read"
                                                              data-toggle="tooltip"
                                                              className="hide-show-toggler-item fa fa-circle-o font-size-11 position-absolute right-0 top-0 mr-3 mt-3"
                                                          />
                                                      </p>
                                                      <span className="text-muted small">
                                                          20 min ago
