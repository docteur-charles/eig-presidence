		...
		<form onSubmit={handleSubmit}>
			...
			{preview && !register ? (
				<div className="container-fluid row position-relative align-items-center justify-content-center">
					...
					>
						<p
							className={`${fromDesktop() ? "font-size-20" : "font-size-18"
								}`}
						>
				...
				""
						...
						<div
							className={`row col-12 ${fromExtraLarge()
								? isExtraLarge()
									? "col-lg-5"
									: "col-lg-4"
								: "col-md-7"
						...
						>
							<div
								className={`card-header ${fromDesktop() ? "p-40 font-size-25" : "font-size-18"
                        ...
                        <small className="font-size-20">
							...
							<div className={`card-body ${fromDesktop() ? "p-40" : ""}`}>
								<div>
									<div className="row">
										<div className="form-group col-12 col-md-6">
											...
											>
												...
												{auth.role.privileges.some(privilege =>
													REGISTER_CONFIDENTIALS.includes(privilege)
												) && (
										...
										<div className="form-group col-12 col-md-6">
											...
											>
												...
												<option disabled value="SORTANT">Sortant</option>
												<option disabled value="INTERNE">Interne</option>
											</select>
										</div>
									</div>
									...
									<div
										className={`d-flex align-items-start m-t-20 ${!fromTablet() ? "flex-column" : ""
											}`}
									>
										<p>
										...
										<button
											type="submit"
											className={`btn ${fromTablet() ? "col-4" : "col-12"
